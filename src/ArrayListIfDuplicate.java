...
public class ArrayListIfDuplicate {
	public static void main(String[] args) {
		List<Integer> list1 = new ArrayList<>(); // List : accepts duplicates, keeps insertion order, has index
		...
		// Check if the original list size is different from the size of the distinct list if so then print the distinct list
		if (list1.size() != distinctList.size()) {
			System.out.println("Distinct list: " + distinctList);
		}


		// How to get the distinct size of List of objects using stream
